========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : EasyWiz
========================================================================


AppWizard が生成した EasyWiz には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには EasyWiz を構成している各ファイルの概要説明が含まれています。
...
EasyWiz.h
    ...
    みます） をインクルードし、また CEasyWizApp アプリケーションクラスを宣
    言します。

EasyWiz.cpp
    このファイルは CEasyWizApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\EasyWiz.ico
    ...
    ルです。このアイコンはリソース ファイル EasyWiz.rc によってインクルード
    されます。
...
EasyWizDlg.h, EasyWizDlg.cpp - ダイアログ
    これらのファイルは CEasyWizDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な EasyWiz.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) EasyWiz.pch 
